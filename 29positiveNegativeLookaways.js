...
let sampleWord = "astronaut";
let pwRegex = /(?=\w{6})(?=\w*\d{2})/;  // Change this line; the first positive lookahead {} is 6 because we are trying to 
                                        // match 5 or greater
let result = pwRegex.test(sampleWord);
...
/*
E:\githubrepo_local\Regex>node 29positiveNegativeLookaways.js
false
